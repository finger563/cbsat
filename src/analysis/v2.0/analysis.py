...
def analyze(required, provided, config, options):
    ...
    * (Optionally plots the bandwidths and data for the profiles)
    ...
    :param required: :class:`networkProfile.Profile` describing the provided profile
    :param required: :class:`networkConfig.Config` describing the configuration of the network
    :param required: :class:`Options` describing the program options for drawing and analysis

    Returns a list of analysis results consisting, in order, of:
